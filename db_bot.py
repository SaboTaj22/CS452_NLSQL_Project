...
strategies = {
    ...
    "single_domain_double_shot": (setupSqlScript + 
                   ...
                   " \nSELECT trader_name, symbol, quantity, price_per_share\nFROM trades t\nJOIN stocks s ON t.stock_id = s.stock_id\nWHERE winner_or_loser = 'winner';\n " +
...
questions = [
    "Which trades were winners?",
    "Which trades were losers?",
    "Which stock had the most trades?",
    "Which trader had the highest number of winning trades?",
    "What were the average prices for each stock traded?"
]
...
for strategy in strategies:
    ...
    for question in questions:
        ...
        try:
            ...
            friendlyResultsPrompt = "I asked about stock trades. The response was \"" + queryRawResponse + "\" Please summarize this data in a friendly way, as if you are explaining to someone who is new to trading."
